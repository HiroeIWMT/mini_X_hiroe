...
// 書き直し
// $_REQUEST['action'] が 'rewrite' であることを確認
if (isset($_REQUEST['action']) && $_REQUEST['action'] == 'rewrite') {
    // セッション変数 $_SESSION['join'] が存在するか確認
    if (isset($_SESSION['join'])) {
        // $_POST をセッション変数 $_SESSION['join'] の値で上書き
        $_POST = $_SESSION['join'];
        // エラーフラグをセット
        $error['rewrite'] = true;
    }
...
<div id="wrap">
  ...
  <div id="content">
		...
		<dd><input type="text" name="name" size="35" maxlength="255"value="<?php echo isset($_POST['name']) ? htmlspecialchars($_POST['name'], ENT_QUOTES) : ''; ?>"
